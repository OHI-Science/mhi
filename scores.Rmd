...
Ocean Health Index scores are calculated for each region for each goal before being combined into an overall Index score for the Main Hawaiian Islands. The four regions are Hawaii, Maui Nui, Oahu, and Kauai & Niihau. <!---could bring back the Regions page to be only linked from here---> 
...
These scores are draft scores and are under construction. For more information on how these scores are calculated see our draft technical report [here](https://drive.google.com/file/d/1EMfa4qQ1nEYWSEnY5ZyB5xNDK1UmukOh/view?usp=sharing).
