...
Full report on the 2016 State of Hawaiʻi Water Quality Monitoring and Assessment can be found [here]( https://health.hawaii.gov/cwb/files/2013/05/Draft-2016-State-of-Hawaii-Water-Quality-Monitoring-and-Assessment-Report.pdf).
...
Agriculture and golf course land use practice can cause increased chemicals and nutrients to our nearshore waters. Land use practices vary by island and county across Hawaiʻi.

Total agriculture and golf course land use area:
...
####*Land Development*
Development of roads and structures leads to increased areas of impervious surfaces (do not allow for water aborption and filtration). This rural and city development causes increased transport or runoff of chemicals and pollutants to our streams and nearshore waters. We mapped the average percent of impervious surfaces for each watershed and applied this pressure to Biodiversity, Artisanal Fishing Opportunites, Coastal Protection, Sense of Place, and Sustainable Tourism goals.

| County  | % of Watersheds Covered by Impervious Surfaces  |
| ---- |  ---- |
| Hawaiʻi |   1.3 |
| Maui Nui  |  4.5 |
|Oʻahu  |   14.0  |
...
Ocean habitats are impacted by human habitat modification from coastal development, dredging of the seafloor, harbor development, shipping and boating activities, destructive fishing practices, and human use and recreation. These impacts have been taken into account in the Hawaiʻi Ocean Health Index.

<img src="images/HABITAT_DESTRUCTION_15J_KM.pdf" width="750px"></div>
