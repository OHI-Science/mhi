...
The reference value for average annual wages for each ocean sector was referenced to the state average wage and weighted by the proportion of jobs per sector.
